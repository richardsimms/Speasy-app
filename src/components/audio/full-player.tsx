...
export function FullPlayer() {
  ...
  // Animate in when opened - sync external animation system (framer-motion) with React props
  // This is a valid use case: synchronizing external systems with React state
  useEffect(() => {
    if (isOpen) {
      controls.set({ y: 0 });
    } else {
