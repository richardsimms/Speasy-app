  ...
  return (
    <div className="space-y-8">
      ...
      <div
        ...
        className="-mx-2 flex w-full max-w-full items-center overflow-x-auto px-2 pt-2 pb-2 [-ms-overflow-style:none] [scrollbar-width:none] sm:-mx-4 sm:px-4 [&::-webkit-scrollbar]:hidden"
      >
